...
namespace Utilities
{
    ...
    {
        public static CSVReader instance = new CSVReader();

        public List<string[]> GetData(string filepath, char lineseparator, char cellseparator)
        {
            ...
            if (File.Exists(filepath))
            {
                try
                {
                    ...
                    ReverseLineReader backwardsFile = new ReverseLineReader(filepath);
                    foreach(string line in backwardsFile){
                        string[] values = line.Split(cellseparator);
                        ActionList.Add(values);                        
                    }
            ...
            {
                throw new FileNotFoundException("No CSV File Found there, you poor SOB");
            }
        }
